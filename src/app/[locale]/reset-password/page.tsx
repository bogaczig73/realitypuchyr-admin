...
export default function ResetPassword(){
    return(
        <>
        <section className="h-screen flex items-center justify-center relative overflow-hidden bg-no-repeat bg-left-bottom bg-cover" style={{backgroundImage:`url('/images/01.jpg')`}}>
